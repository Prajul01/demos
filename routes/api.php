...
Route::post('scholarship/delete/{id}',[ScholarshipController::class,'delete']);
...
Route::post('studymaterial/delete/{id}',[StudyMaterialController::class,'delete']);
...
Route::post('administration/delete/{id}',[AdministrationController::class,'delete']);
...
Route::post('infrastructure/delete/{id}',[InfrastructureController::class,'delete']);
...
Route::post('lunch/delete/{id}',[LunchController::class,'delete']);
...
Route::post('employeesalaryscale/delete/{id}',[EmployeeSalaryScaleController::class,'delete']);
...
Route::post('employeegradelimit/delete/{id}',[EmployeeGradeLimitController::class,'delete']);
...
Route::post('employeegradescale/delete/{id}',[EmployeeGradeScaleController::class,'delete']);
...
Route::post('employeeAllowanceScale/delete/{id}',[EmployeeAllowanceScaleController::class,'delete']);
...
Route::post('lunchScale/delete/{id}',[LunchScaleController::class,'delete']);
...
Route::post('scholarshipScale/delete/{id}',[ScholarshipScaleController::class,'delete']);
...
Route::post('infrastructureScale/delete/{id}',[InfrastructureScaleController::class,'delete']);
...
Route::post('administrationScale/delete/{id}',[AdministrationScaleController::class,'delete']);
...
Route::post('signature/delete/{id}',[SignatureController::class,'delete']);
...
Route::post('salarysheet/delete/{id}',[SalarySheetController::class,'delete']);
...
Route::post('fiscalyear/delete/{id}',[FiscalYearController::class,'delete']);
...
Route::post('educationyear/delete/{id}',[EducationYearController::class,'delete']);
